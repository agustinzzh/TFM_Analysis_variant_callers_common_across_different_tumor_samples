...
#SBATCH --output=LogsNas_014_Strelka2_N5.log
#SBATCH --mem=20G
...
/home/zzhang.6/strelka-2.9.2.centos6_x86_64/bin/configureStrelkaSomaticWorkflow.py \
    ...
    --runDir /home/zzhang.6/TFM/results/results_strelka2
# execution on a single local machine with 20 parallel jobs
/home/zzhang.6/TFM/results/results_strelka2/runWorkflow.py -m local -j 20
