...
#SBATCH --output=Log_summary_aog.log
#SBATCH --mem=20G
...
vcf=/home/zzhang.6/TFM/raw_data/af-only-gnomad.hg38.vcf.gz

cd /home/zzhang.6/TFM/results/Mutect2

gatk GetPileupSummaries  -I ${tumor} -V ${vcf} -L ${vcf} -O tumor-af-only-gnomad.table
