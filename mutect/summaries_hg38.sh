...
#SBATCH --output=Log_summaries_hg38.log
#SBATCH --mem=20G
...
vcf=/home/zzhang.6/TFM/raw_data/small_exac_common_3.hg38.vcf.gz

cd /home/zzhang.6/TFM/results/Mutect2

gatk GetPileupSummaries  -I ${tumor} -V ${vcf} -L ${vcf} -O tumor-hg38.table
