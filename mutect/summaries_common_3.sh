...
#SBATCH --output=Log_summary_small_exac_common_3.log
#SBATCH --mem=20G
...
vcf=/home/zzhang.6/TFM/raw_data/small_exac_common_3.vcf

cd /home/zzhang.6/TFM/results/Mutect2

gatk GetPileupSummaries  -I ${tumor} -V ${vcf} -L ${vcf} -O tumor-small_exac_common_3.table
