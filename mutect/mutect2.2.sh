...
#SBATCH --output=Log_Mutect2_2.2.log
#SBATCH --mem=20G
...
cd /home/zzhang.6/TFM/Mutect2

gatk GenomicsDBImport -R ${GENOME} -L normal.interval_list --genomicsdb-workspace-path pon_db -V normal.vcf.gz
