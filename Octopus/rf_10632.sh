...
#SBATCH --output=Log_10632_octopus_rf.log
#SBATCH --mem=20G
...
octopus -R ${ref} -I ${bam_normal} ${bam_tumor} --normal-sample Hepa_normal --forest ${rfg} --somatic-forest ${rf} -o filtered_10632.vcf
