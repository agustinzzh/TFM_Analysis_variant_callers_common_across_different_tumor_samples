...
#SBATCH --output=Log_10628_octopus_rf.log
#SBATCH --mem=20G
...
octopus -R ${ref} -I ${bam_normal} ${bam_tumor} --normal-sample Hepa_normal --forest ${rfg} --somatic-forest ${rf} -o filtered_10628.vcf
