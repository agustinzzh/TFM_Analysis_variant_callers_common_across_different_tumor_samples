...
vcfn=/home/zzhang.6/TFM/raw_data/genome_10619.vcf
...
normal=/home/zzhang.6/TFM/raw_data/bam_hepamut/10619_normal.printed.bam
cd /home/zzhang.6/TFM/results/Moss2

moss -r ${ref} -b ${bam} -b ${bam19} -b ${bam22} -b ${bam28} -b ${bam32} -n ${vcfn} -v ${vcf} -v ${vcf2} -v ${vcf3} -v ${vcf4} -m 4 -t -0.693 --ignore0 --grid-size 200 -o moss2.vcf
